...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Path to the frame manifest JSON generated by bundle_images.py. "
            "Used to align annotation ordering with the bundled media."
        ),
    )
    parser.add_argument(
        "--skip-manifest",
    ...
    if args.skip_manifest:
        ...
        if manifest_candidate and manifest_candidate.exists():
            ...
            if args.require_manifest:
                ...
                return 1
            logging.info("Manifest not found at %s; proceeding without alignment", manifest_candidate)
